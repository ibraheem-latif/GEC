...
const testimonials = [
  { name: 'Margaret T.', location: 'Glasgow', text: 'Used Glasgow Executive Chauffeurs for an early morning airport run. Driver was waiting at the door before I even came downstairs. Professional from start to finish.', service: 'Airport Transfer' },
  { name: 'James R.', location: 'Edinburgh', text: "Booked a full-day Highland tour for my wife's birthday. The driver was knowledgeable, patient, and made the whole day feel special. Highly recommend.", service: 'Scotland Tour' },
  { name: 'David M.', location: 'Glasgow', text: 'We use them for all our executive travel. Always punctual, always immaculate. The company account billing makes everything seamless.', service: 'Corporate Chauffeur' },
]
