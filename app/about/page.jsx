      ...
      <section style={{ background: 'var(--deep)', position: 'relative', overflow: 'hidden', paddingTop: '5rem' }}>
        ...
        >
          <div style={{
            ...
            <p style={{ fontFamily: 'var(--font-dm-sans), sans-serif', color: 'var(--white-dim)', lineHeight: 1.8, fontSize: '0.9875rem', marginBottom: '1rem', maxWidth: '44ch' }}>
            ...
            <p style={{ fontFamily: 'var(--font-dm-sans), sans-serif', color: 'var(--white-dim)', lineHeight: 1.8, fontSize: '0.9875rem', marginBottom: '3rem', maxWidth: '44ch' }}>
            ...
            <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
              ...
              <Link href="/fleet" className="btn-ghost">View Our Fleet</Link>
            </div>
          </div>
